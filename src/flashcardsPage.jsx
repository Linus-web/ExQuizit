...
const FlashcardPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center p-4">
      <Link to="/" className="hover:underline absolute w-10 fill-primary-dark dark:fill-primary-light self-start">
      ...
      <h1 className="text-3xl font-bold mb-8">Quiz Flashcards</h1>
      {flashcards.length > 0 ? (
        <div
          className="flip-card w-full max-w-lg p-8 rounded-lg flex flex-col items-center"
          onClick={() => setShowAnswer(!showAnswer)}
        >
          <div className={`flip-card-inner ${showAnswer ? 'show-back' : ''} w-11/12 h-56 sm:w-96`}>
            {/* Front Side (Question) */}
